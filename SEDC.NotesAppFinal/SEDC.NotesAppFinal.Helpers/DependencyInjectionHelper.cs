namespace SEDC.NotesAppFinal.Helpers
{
    ...
    public static class DependencyInjectionHelper
    {
        ...
        {
            services.AddDbContext<NotesDbContext>(options => options.UseSqlServer(@"Data Source=(localdb)\LocalDBDemo;Database=NotesAppFinalDb1;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"));
        }
