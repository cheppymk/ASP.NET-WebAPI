...
namespace SEDC.NotesAppFinal.Tests
{
    ...
    public class NotesTest
    {
        ...
        {
            var builder = new DbContextOptionsBuilder<NotesDbContext>().UseSqlServer(@"Data Source=(localdb)\LocalDBDemo;Database=NotesAppFinalDb1;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
